...
# Determine the service type from environment variable
...
if SERVICE_TYPE == 'bookslibrary':
    INSTALLED_APPS.append('apps.bookslibrary.bookstore')
elif SERVICE_TYPE == 'djangocommerce':
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://user:password@db:5432/codefleet_' + SERVICE_TYPE
    )
}
